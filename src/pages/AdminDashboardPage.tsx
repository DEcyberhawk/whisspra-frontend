...
const navItems = [
  ...
  // Forge (custom spark/forge icon)
  { 
    name: 'Forge', 
    path: '/admin/forge', 
    icon: 'M11.049 2.927l2.122 6.543h6.873l-5.558 4.04 2.122 6.543-5.559-4.04-5.558 4.04 2.122-6.543-5.558-4.04h6.873l2.121-6.543z' 
  },
